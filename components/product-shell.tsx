...
import {
  ...
  Play, Search, Settings, ShieldCheck, Square, Target, Timer, Trophy, UserRound, UsersRound, X,
} from "lucide-react";
...
const commands = [
  ...
  { label: "View analytics", hint: "G A", href: "/app/analytics", icon: BarChart3 },
...
export function ProductShell({ children }: { children: React.ReactNode }) {
  const { collapsed,mobileOpen,setMobileOpen,sessionRunning,toggleSession }=useSprintlyStore();
  ...
  const onSession=()=>{toggleSession();toast.success(sessionRunning?"Session stopped — saved locally":"Session started locally",{description:sessionRunning?"Your activity summary is ready.":"Only aggregate activity will be recorded."})};
