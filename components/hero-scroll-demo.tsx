...
export function HeroScrollDemo() {
  return (
    <section className="overflow-hidden border-y border-white/[.07] bg-[#090b0e]">
      <ContainerScroll
        titleComponent={
          <div className="px-3">
            <p className="mono text-xs uppercase tracking-[.2em] text-[#32c7d9]">
              Your work, made legible
            </p>
            <h2 className="text-balance mt-5 text-3xl font-semibold tracking-[-.05em] text-[#f4f2ed] sm:text-5xl md:text-6xl">
              Watch focused hours turn into
              <span className="block bg-gradient-to-r from-[#9b8cff] to-[#32c7d9] bg-clip-text text-transparent">
