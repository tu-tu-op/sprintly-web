...
type PatternFunction = (x: number, y: number) => number | null;
...
const PATTERNS: Record<PixelPattern, PatternFunction> = {
  random: () => null,
...
const makeEasing = (value: string): EasingFunction => {
  ...
  useEffect(() => {
    ...
    frozenGrid.pixels.forEach((pixel, index) => {
      ...
      animationsRef.current.push(
        ...
        content.animate(contentFrames, timing),
      );
    });
