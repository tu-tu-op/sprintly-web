...
export function FlowButton({ text = "Modern Button" }: { text?: string }) {
  return (
    ...
    >
      <span className="relative z-[1] -translate-x-3 transition-all duration-[800ms] ease-out">
        {text}
      </span>
      ...
      <ArrowRight
        className="absolute right-4 z-[9] h-4 w-4 fill-none stroke-[#111111] transition-all duration-[800ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:stroke-white"
      />
    </button>
  );
}
