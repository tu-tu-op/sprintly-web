        ...
        <section className="relative overflow-hidden border-b border-white/[.07] bg-[#090b0e]">
          ...
          <HeroScrollDemo
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link href="/app" className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#7c6cf2] px-5 text-sm font-semibold text-white transition hover:bg-[#8b7cf7] sm:w-auto"><Play aria-hidden="true" className="size-4 fill-current" /> Explore live product</Link>
