...
function Footer() {
  return <footer className="border-t border-white/[.07] py-12"><div className="mx-auto grid max-w-[1240px] gap-10 px-4 sm:px-6 md:grid-cols-[1.2fr_2fr]"><div><Brand /><p className="mt-4 max-w-xs text-sm leading-6 text-[#787878]">Private by default. Useful every day. Copyright 2026 Sprintly.</p></div><div className="grid grid-cols-2 gap-8 text-sm sm:grid-cols-3"><div><p className="mono text-[10px] uppercase tracking-[.18em] text-[#5f5f5f]">Explore</p><div className="mt-4 grid gap-3 text-[#a2a2a2]"><Link href="/product">Product</Link><Link href="/how-it-works">How it works</Link><Link href="/for-teams">For teams</Link></div></div><div><p className="mono text-[10px] uppercase tracking-[.18em] text-[#5f5f5f]">Trust</p><div className="mt-4 grid gap-3 text-[#a2a2a2]"><Link href="/privacy">Privacy</Link><Link href="/pricing">Pricing</Link></div></div><div><p className="mono text-[10px] uppercase tracking-[.18em] text-[#5f5f5f]">Account</p><div className="mt-4 grid gap-3 text-[#a2a2a2]"><Link href="/sign-in">Sign in</Link><Link href="/app">Open Sprintly</Link></div></div></div></div></footer>;
}
