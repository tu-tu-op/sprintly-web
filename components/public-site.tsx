          ...
          <HeroScrollDemo
            ...
            afterComponent={
              <motion.div {...reveal} className="relative z-10 mx-auto -mt-16 max-w-[920px] px-4 pb-24 text-center sm:-mt-20">
                <p className="text-pretty mx-auto max-w-2xl text-base leading-7 text-[#9aa1ad] sm:text-lg">Sprintly turns focused coding sessions into a private record of consistency, momentum, and the developer you’re becoming.</p>
