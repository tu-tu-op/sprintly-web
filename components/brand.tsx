...
export function SprintlyMark({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" role="img" aria-label="Sprintly">
      <rect x="1" y="1" width="30" height="30" rx="9" fill="#7C6CF2" />
      <path d="M9 11.5h8.6a3.4 3.4 0 0 1 0 6.8H14a3.4 3.4 0 0 0 0 6.8h9" fill="none" stroke="#F8F7F3" strokeWidth="3" strokeLinecap="round" />
      <path d="M8.5 7.5h8" stroke="#32C7D9" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
